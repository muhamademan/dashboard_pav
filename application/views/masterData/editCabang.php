    ...
    <div class="col-md-12 align-center">
        ...
        <div class="card shadow">
            <div class="card-header bg-info border-bottom-warning">
                <span class="text-light">FORM EDIT MASTER DATA CABANG</span>
            </div>
            <div class="card-body">
                <form action="<?= base_url('master_data/proses_editCabang') ?>" method="post">
                    <div class="row">
                        <input type="hidden" name="ID_CABANG" value="<?= $edit_cabang['ID_CABANG'] ?>">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="STATUS_CABANG" type="text" class="form-control" id="STATUS_CABANG"
                                    ...
                                    value="<?= $edit_cabang['STATUS_CABANG'] ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="HPKACAB" type="text" class="form-control" id="HPKACAB" autocomplete="off"
                                    value="<?= $edit_cabang['HPKACAB'] ?>" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="KACAB" id="KACAB" class="form-control selectpicker"
                                    ...
                                    oninput="setCustomValidity('')">
                                    <!-- <option value="" selected disabled>--selected--</option> -->
                                    <?php if ($edit_cabang['USER_NAME']) { ?>
                                    <option value="<?= $edit_cabang['USER_NAME'] ?>" selected>
                                        <?= $edit_cabang['USER_NAME'] ?>
                                    </option>
                                    <?php } ?>
                                    <?php foreach ($dt_picKacab2 as $kacab) { ?>
                                    <option value="<?= $kacab['USER_NAME'] ?>">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="NAMA_PIC_CAB" type="text" class="form-control" id="NAMA_PIC_CAB"
                                    autocomplete="off" required onkeyup="this.value = this.value.toUpperCase();"
                                    value="<?= $edit_cabang['NAMA_PIC_CAB'] ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="HPPIC" type="text" class="form-control" id="HPPIC" autocomplete="off"
                                    value="<?= $edit_cabang['HPPIC'] ?>" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="EMAILPIC"><small>Alamat Email</small><span
                                        class="text-danger small">*</span></label>
                                <input name="EMAILPIC" type="email" class="form-control" id="EMAILPIC"
                                    value="<?= $edit_cabang['EMAILPIC'] ?>" autocomplete="off" value="" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="ROLE" id="ROLE" class="form-control" required>
                                    <option value="" selected disabled>--selected--</option>
                                    <option value="BRANCH_OPS" <?php if ($edit_cabang['ROLE'] == "BRANCH_OPS") {
                                                                    echo "selected";
                                                                } ?>>BRANCH_OPS | Kepala Cabang</option>
                                    <option value="BPN_OPS3" <?php if ($edit_cabang['ROLE'] == "BPN_OPS3") {
                                                                    echo "selected";
                                                                } ?>>BPN_OPS3 | User</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="ALAMAT" type="text" class="form-control" id="ALAMAT" autocomplete="off"
                                    ...
                                    value="<?= $edit_cabang['ALAMAT'] ?>"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-3 text-center">
                                <a href="<?= base_url('master_data/md_cabang') ?>"
                                    class="btn btn-block btn-lg btn-outline-danger"><i
                                        class="fa fa-backward mx-3"></i>Batal</a>
                            </div>
                        </div>
                    </div>
                </form>
